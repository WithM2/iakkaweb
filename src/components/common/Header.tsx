        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          <button
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" className="h-5 w-5">
                <path stroke="currentColor" strokeWidth="1.5" d="M12 21c4.97 0 9-4.03 9-9s-4.03-9-9-9-9 4.03-9 9 4.03 9 9 9Z"/>
                <path stroke="currentColor" strokeWidth="1.5" d="M3 12h18M12 3c2.5 2.6 3.75 5.6 3.75 9S14.5 17.4 12 21M12 3c-2.5 2.6-3.75 5.6-3.75 9S9.5 17.4 12 21"/>
            </svg>
          </button>
